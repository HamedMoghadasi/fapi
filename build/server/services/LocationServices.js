...
var LocationService = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LocationService, null, [{
    key: "getAll",
    value: function () {
    ...
    key: "add",
    value: function () {
      var _add = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(newLocation) {
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                return _context3.abrupt("return", _models["default"].Locations.create(newLocation)["catch"](function (error) {
                  throw error;
                }));
    ...
    key: "update",
    value: function () {
      var _update = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(id, updatedLocation) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return _models["default"].Locations.findOne({
                  where: {
                    id: Number(id)
                  }
                });
              ...
              case 3:
                LocationToUpdate = _context4.sent;
                ...
                _context4.next = 7;
                return _models["default"].Locations.update(updatedLocation, {
                  where: {
                    id: Number(id)
                  }
                });
              ...
              case 7:
                return _context4.abrupt("return", updatedLocation);
    ...
    value: function () {
      var _delete2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(id) {
        var LocationToDelete, deletedLocation;
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                LocationToDelete = _context5.sent;
                ...
                _context5.next = 7;
                return _models["default"].Locations.destroy({
                  where: {
                    id: Number(id)
                  }
                });
              ...
              case 7:
                ...
                return _context5.abrupt("return", deletedLocation);
